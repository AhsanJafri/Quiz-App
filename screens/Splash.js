...
export default class Splash extends Component {
  ...
  animation = () => {
    Animated.sequence([
      ...
      setTimeout(() => this.props.navigation.navigate('UserFormScreen'), 2000);
    });
  };
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Image
          source={{
            uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqP3nocsIhrlTvIQrgQmjDmq5ZiH1GUtfacw&usqp=CAU'
          }}
